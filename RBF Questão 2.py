...
# Definindo os dados de entrada e saída do problema da questão 2:
#Implemente a RNA RBF com as seguintes saídas e entradas do problema de regressão abaixo?
...
X_test = np.array([9, 10, 19, 21, 22, 25, 39, 40, 41, 47])
